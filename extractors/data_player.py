...
def write_bagfile(data_set_name, odom_msgs, tf_msgs, t_lsr_f_msgs,laser_msgs,t_lsr_r_msgs,r_laser_msgs):
...
write_bagfile("combined_updated", odom_msgs, tf_msgs, t_lsr_f_msgs,laser_msgs,t_lsr_r_msgs,r_laser_msgs)